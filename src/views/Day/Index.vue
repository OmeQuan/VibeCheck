<template>
  <div class="container mx-auto px-4">
    ...
    <div class="text-center">
      <div v-if="!today">
        <h1 class="font-light text-cream text-4xl mb-4" id="title">Start a new day</h1>
        <a href @click.prevent="createDay">
          <Icon name="plus" :width="48" :height="48" class="text-cream align-bottom" />
        </a>
      </div>
      <div v-if="today">
        <h1 class="font-light text-cream text-4xl" id="title">Your day so far</h1>
        <div class="mb-2">
          <span
            class="opacity-50 font-light text-cream text-xl"
    ...
    <div v-if="today">
      ...
      <div v-if="!today.to_sleep_time" class="fixed bottom-0 left-0 ml-4 mb-16">
        <button class="rounded-full bg-dark100" @click.prevent="addSleep" id="create-activity">
          <Icon
            name="moon"
            :width="36"
            :height="36"
